...
public class uGUITools : MonoBehaviour {
	...
	[MenuItem("uGUI/Anchors to Corners #[")]
	static void AnchorsToCornersAll(){
	...
	private static void SetAnchors(Transform item){
		RectTransform t = item as RectTransform;
		RectTransform pt = item.parent as RectTransform;
